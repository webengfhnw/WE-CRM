...
<div class="container">
            ...
            <tr>
                ...
                <td>
                    <div class="btn-group btn-group-sm" role="group">
                        <a class="btn btn-default" role="button" href="#"> <i class="fa fa-edit"></i></a>
                        <button class="btn btn-default" type="button" data-target="#confirm-modal" data-toggle="modal" data-href="#"> <i class="glyphicon glyphicon-trash"></i></button>
                    </div>
                </td>
            </tr>
            <tr>
    ...
    <div class="btn-group" role="group">
        <a class="btn btn-default" role="button" href="#"> <i class="fa fa-plus-square-o"></i></a>
